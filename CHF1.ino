...
//PARAMETER 4
  ...
  emicSerial.print('S');
  emicSerial.print("Would you like this patient to report ECG? Please type YES or NO");
  emicSerial.print('\n');
  emicSerial.flush();
  delay(3000);
  ...
  while((kinput != "YES") && (kinput != "NO"))
   {
      emicSerial.print('S');
      emicSerial.print("Incorrect response. Should this patient report ECG?");
      emicSerial.print('\n');
      emicSerial.flush();
      keyinput();
      Serial.print("This is your input: ");
...
/*
  ...
  delay(3000); */
   ...
   //delay(2000);
  emicSerial.print('S');
  emicSerial.print("Thank you. MEDLINK has been successfully programmed. Confirmation has been sent to your e-mail address. You can now switch MEDLINK off. ");  // Send the desired string to convert to speech
  emicSerial.print('\n');
  emicSerial.flush();
  delay(2000);
  ...
  if (result == 13)
   { 
     ...
     Serial.println("Taking Spirometer Data . . .");  // Send the desired string to convert to speech
      ...
      emicSerial.print('S');
      emicSerial.print("Connect the Pressure Sensor to the cables in Box 3 and press Enter");  // Send the desired string to convert to speech
      emicSerial.print('\n');
      emicSerial.flush();
      delay(1000);
      keyinput();
  ...
  if (result == 13)
   { 
     ...
     Serial.println("Taking ECG . . .");  // Send the desired string to convert to speech
      ...
      emicSerial.print('S');
      emicSerial.print("Connect the E C G cable in Box 4 and press Enter");  // Send the desired string to convert to speech
      emicSerial.print('\n');
      emicSerial.flush();
      delay(1000);
      keyinput();
