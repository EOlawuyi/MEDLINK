...
byte rowPins2[ROWS2] = {6, 5, 4, 3, 2}; // connect to pins 9,8,7,6,5 pinouts of the keypad (row pinouts)
byte colPins2[COLS2] = {17, 16, 15, 14}; // connect to pins 1, 2, 3, 4 pinouts of the keypad (column pinouts)
  ...
  if (result == 13)
   { 
     //Body Temperature
      ...
      bodytemperature();
      delay(2000);
      Serial.println("Bidy Temperature: ");
      Serial.println(mytemp);
      delay(3000);
      emicSerial.print('S');
      emicSerial.print(mytemp);  // Send the desired string to convert to speech
      emicSerial.print('\n');
      emicSerial.flush();
      delay(4000);
