...
byte rowPins1[ROWS1] = {37, 38, 39, 40, 41}; // connect to pins 9, 8, 7, 6, 5 pinouts of the keypad (row pinouts)
byte colPins1[COLS1] = {45, 44, 43, 42}; // connect to pins 1, 2, 3, 4 pinouts of the keypad     (column pinouts)
byte rowPins2[ROWS2] = {4, 3, 2, 14, 15}; // connect to pins 9,8,7,6,5 pinouts of the keypad (row pinouts)
byte colPins2[COLS2] = {19, 18, 17, 16}; // connect to pins 1, 2, 3, 4 pinouts of the keypad (column pinouts)
...
String kinput;
String tester[8];
String phyname, phymail, patname, patid, physsid, phyword, patssid, patword, stpara;
int mode;
int phyparameters[4];
...
/*
  ...
  delay(3000); */
   ...
   //delay(2000);
  emicSerial.print('S');
  emicSerial.print("Thank you. MEDLINK has been successfully programmed. Confirmation has been sent to your e-mail. You can now switch MEDLINK off. ");  // Send the desired string to convert to speech
  emicSerial.print('\n');
  emicSerial.flush();
  delay(2000);
 ...
 //Serial.println(result);
  ...
  if (result == 13)
   { 
     //E  M G
      emicSerial.print('S');
      emicSerial.print("Switch on the E M. G. Sensor in Box 2 and press Enter");  // Send the desired string to convert to speech
      emicSerial.print('\n');
      emicSerial.flush();                                                                 
      delay(3000);
      keyinput();
      ...
      emicSerial.print('S');
      emicSerial.print("Connect the E M. G. Cables to your body and Press Enter");  // Send the desired string to convert to speech
      emicSerial.print('\n');
      emicSerial.flush();                                                                 
      delay(3000);
      keyinput();
      ...
      emicSerial.print('S');
      emicSerial.print("Run the E M G Software on your computer. Get your Muscle DATA from it then press Enter");  // Send the desired string to convert to speech
      emicSerial.print('\n');
      emicSerial.flush();                                                                 
      delay(3000);
      keyinput();
      ...
      emicSerial.print('S');
      emicSerial.print("Enter the value of your E M G Data 1 and then press Enter");  // Send the desired string to convert to speech
      emicSerial.print('\n');
      emicSerial.flush();                                                                 
      delay(3000);
      keyinput();
      ...
      emicSerial.print('S');
      emicSerial.print("Enter the value of your E M G Data 2 and then press Enter");  // Send the desired string to convert to speech
      emicSerial.print('\n');
      emicSerial.flush();                                                                 
      delay(3000);
      keyinput();
...
*/
    ...
    esp32.println("9");
    delay(8000);
    Serial.println(phyname);
    esp32.println(phyname);
    delay(2000);
    Serial.println(phymail);
    esp32.println(phymail);
    delay(2000);
    Serial.println(patname);
    esp32.println(patname);
    delay(2000);
    Serial.println(patid);
    esp32.println(patid);
    delay(2000);
    Serial.println(hrate/10);
    esp32.println(hrate/10);
    delay(2000);
    Serial.println(emg1);
    esp32.println(emg1);
    delay(2000);
    ...
    esp32.println(emg8);
    delay(2000);
    Serial.println(patssid);
    esp32.println(patssid);
    delay(2000);
    Serial.println(patword);
    esp32.println(patword);
    delay(12000);
    delay(6000);
